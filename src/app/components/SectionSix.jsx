...
const SectionSix = () => {
    return (
        <div className={`container flex items-center justify-between bg-backgroundSecondary   ${styles.section}`}>
            <div>
                <Image src={Modern} width={498} height={351} alt='' />
            </div>
            <div className={`flex items-center flex-wrap ${styles.leftSection}`} >
                <h2 className='font-black text-3xl leading-10 text-black'>Become an ambassador</h2>
                <button className="w-44	h-14 flex items-center justify-center flex-row gap-1  flex-nowrap bg-primary">
                    ...
                    <MdArrowOutward className="text-secondary h-2.5 w-2.5" />
