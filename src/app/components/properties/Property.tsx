...
const Property = () => {
  return (
    <div
      className={`sm:pt-[80px] sm:pb-[100px] sm:text-center justify-center  md:pb-[80px] container flex items-center gap-9 bg-backgroundSecondary p-7  ${styles.section}`}
    >
      <div className={`flex items-center flex-wrap ${styles.leftSection}`}>
        <h2 className="font-black text-3xl leading-10 text-black mb-6 md:mb-0">
      ...
      <Image
        ...
        alt="Modern Residential District"
      />
    </div>
  );
};
