                ...
                {data.map((card) => {
                    return (
                        <div className={`flex items-center flex-wrap cursor-grab text-left ${styles.card}`}
                            key={card.id} >
                            <Image className={`${styles.Image}`} src={card.image} width={370} height={308.55} draggable="false" alt={card.name} />
                            ...
                            <div className="px-6">
                                ...
                                <div className="flex items-center justify-between">
                                    <div>
                                        <h3 className="font-sans text-base leading-4 font-bold text-primary pb-1">{card.price}EGP</h3>

                                        <p className="font-sans text-xs	font-normal leading-4 text-monthlyColor">{card.monthly}Monthly</p>
                                    </div>
