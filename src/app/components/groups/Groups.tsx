...
export const Groups = () => {
  return (
    <div className="container flex flex-col md:flex-row items-center justify-between pt-14 pb-14 m-auto flex-wrap">
      <div className="sm:pt-[50px] md:pt-[10px] flex flex-col items-center md:border-r border-gray-200 md:pr-24">
      ...
      <div className="sm:pt-[50px] md:pt-[10px] flex flex-col items-center">
