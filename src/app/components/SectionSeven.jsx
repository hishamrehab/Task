    ...
    return (
        <div className='relative z-5' >
            <div
                ...
                <div className={`flex flex-col flex-start mt-16 ${styles.sectionSevenLeft}`}>
                    <h3 className="text-3xl block font-black mb-14 text-primary">We'll help you find a place you'll love!</h3>
                ...
                <div className={` border border-borderColor ${styles.sectionSevenRight}`}>


                    <div className='section-seven-right-content text-left p-12'>

                        <h3 className="text-2xl font-black mb-1 text-primary">Contact us</h3>


                        <p className='text-base	font-normal leading-6 text-primary mb-8'>We will respond as soon as we receive your message.</p>



                        <label htmlFor="name" className="block text-base font-normal text-primary ">
                            Name
                        </label>
                        ...
                        <label htmlFor="email" className="text-base font-normal text-primary">Email Address</label>
                        <input
                            className={`${styles.input}  pt-6 pb-6 pl-6 mb-6 text-sm font-normal outline-0 text-inputColor`}
                            placeholder='Enter your email address'
                            required type="email" name="" id="email"
                        />
                        ...
                        <label htmlFor="number" className="text-base font-normal text-primary">Phone Number</label>
                        <input
                            className={`${styles.input}  pt-6 pb-6 pl-6 mb-6 text-sm font-normal outline-0 text-inputColor`}
                            placeholder='Enter your phone number'
                            required type="number" name="" id="number"
                        />
                        ...
                        <label htmlFor="number" className="block text-base font-normal text-primary">Message</label>

                        <textarea required name="" id="message" placeholder='Enter your message'
